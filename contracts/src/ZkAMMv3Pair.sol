...
/// @title ZkAMMv3Pair
/// @author r00t.fund
/// @notice Core state and low-level operations for ZkAMMv3 (like UniswapV2Pair)
...
contract ZkAMMv3Pair is ReentrancyGuard {
    ...
    /// @dev Only callable by addresses authorized via ZkAMMv3Admin.authorizedCRECallback
