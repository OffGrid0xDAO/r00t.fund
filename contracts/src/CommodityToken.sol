...
/// @notice A global, protocol-wide commodity coin ($RICE, $CARROT, $OAK…). One token
...
///         via the CommodityRegistry. Everyone else must ACQUIRE it (buy from the market
///         or OTC from an existing land) to stock their own parcel.
contract CommodityToken is ERC20 {
    /// @notice The registry that created this commodity (its genesis authority).
    address public immutable registry;
    /// @notice The first grower who tokenized this commodity.
