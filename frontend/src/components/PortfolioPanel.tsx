...
import { RailgunPanel } from './RailgunPanel';
...
type PortfolioTab = 'overview' | 'transfer' | 'withdraw' | 'consolidate' | 'liquidity' | 'railgun';
...
export function PortfolioPanel({
  ...
  const tabs = [
    ...
    {
      id: 'railgun' as const, label: 'railgun', icon: (
        <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <AnimatePresence mode="wait">
        ...
        {activeTab === 'railgun' && (
          <motion.div
            ...
            transition={{ duration: 0.3 }}
          >
            <RailgunPanel shieldedBalance={railgunBalance} pendingBalance={railgunPending} />
          </motion.div>
        )}
      </AnimatePresence>
    </div>
